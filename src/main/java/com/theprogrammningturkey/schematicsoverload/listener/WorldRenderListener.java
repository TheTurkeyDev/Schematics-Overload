package com.theprogrammningturkey.schematicsoverload.listener;
...
public class WorldRenderListener
{
	...
	public void onGuiRender(RenderWorldLastEvent event)
	{
		if(SchematicUtil.pos1 != null && SchematicUtil.pos2 != null)
		{
			...
			Entity entity = SchematicsCore.proxy.getClientPlayer();
			...
			BlockPos pos1 = SchematicUtil.pos1;
			BlockPos pos2 = SchematicUtil.pos2;
